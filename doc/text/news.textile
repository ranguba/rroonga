...
* Removed Groonga::View removed in Groonga Groonga 2.1.2.
* [doc] Add tutorial in English.
** English:  http://ranguba.org/rroonga/en/file.tutorial.html
** Japanese: http://ranguba.org/rroonga/ja/file.tutorial.html
...
* [dumper] Reduced needless new lines in dumped command.
* For installing groonga with this gem:
** Fix the needless install of needless document.
